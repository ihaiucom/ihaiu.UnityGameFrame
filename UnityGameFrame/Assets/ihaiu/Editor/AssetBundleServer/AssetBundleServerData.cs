...
namespace com.ihaiu
{
    public class AssetBundleServerData 
    {
        ...
        public static void CopyUpdateAsset(string serverRoot)
        {
            ...
            if (File.Exists(AssetManagerSetting.EditorFilePath.AssetListUpdate))
            {
                updateAssetListPath = AssetManagerSetting.EditorFilePath.AssetListUpdate;
            }
            else if(File.Exists(AssetManagerSetting.EditorFilePath.AssetListFile))
            {
                updateAssetListPath = AssetManagerSetting.EditorFilePath.AssetListFile;
            }
